# lista quemada 
# productos.py 
# Diccionarios con los productos precargados
productos = {
...
def obtener_producto(id_producto):
    """Retorna los datos del producto de acuerdo a si ID """
    return productos.get( id_producto, None) # si el ID no existe retorna None

...
def analizar_salario(salarios: Tuple[int, ...]) -> None: # todos los valores que agregue son enteros y puede recibir cualquier cantidad
...
def main():
    empleado = (111111, "Santiago Torres;", "Director de Desarrollo")
